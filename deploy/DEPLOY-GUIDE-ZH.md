...
```text
D:\CodexWorkFiles\output\personal-blog-release-20260811-v10.zip
```

上传位置：

```text
/home/xiaoliu/personal-blog-release-20260811-v10.zip
```

## 1. 解压

```bash
mkdir -p /home/xiaoliu/personal-blog-release-20260811-v10
unzip -q /home/xiaoliu/personal-blog-release-20260811-v10.zip \
  -d /home/xiaoliu/personal-blog-release-20260811-v10
```

## 2. 安装静态页面与博客服务

```bash
bash /home/xiaoliu/personal-blog-release-20260811-v10/deploy/install-release.sh
```
