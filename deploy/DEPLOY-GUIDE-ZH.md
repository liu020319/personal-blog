...
```text
D:\CodexWorkFiles\output\personal-blog-release-20260811-v9.zip
```

上传位置：

```text
/home/xiaoliu/personal-blog-release-20260811-v9.zip
```

## 1. 解压

```bash
mkdir -p /home/xiaoliu/personal-blog-release-20260811-v9
unzip -q /home/xiaoliu/personal-blog-release-20260811-v9.zip \
  -d /home/xiaoliu/personal-blog-release-20260811-v9
```

## 2. 安装静态页面与博客服务

```bash
bash /home/xiaoliu/personal-blog-release-20260811-v9/deploy/install-release.sh
```
